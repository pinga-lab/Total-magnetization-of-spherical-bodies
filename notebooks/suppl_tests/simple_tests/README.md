...
the influence of a superposed constant-regional field on the estimated
magnetization direction. Finally, we show the performance of our method in
estimating the magnetization direction of synthetic models similar to that
ones presented by Ellis, Wet and Macleod (2012) and Lelièvre and Oldenburg (2009).
The results with the leasts-squares approach can be seen
