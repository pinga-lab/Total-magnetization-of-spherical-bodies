...
and is embedded in nonmagnetic sediments 
(grey prisms) that are overlaying a basement (represented in white) 
which is magnetized by induction (with intensity $0.1$\,\unit{A\,m^{-1}}),
generating a regional anomaly (not shown). The sedimentary 
