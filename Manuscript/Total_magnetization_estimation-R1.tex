...
\begin{abstract}
  ...
  the alkaline complex of Montes Claros de Goi\'{a}s. These results
  ...
  in the alkaline complex of Montes Claros de Goi\'{a}s, strongly
...
and plays an important role in mineral and oil exploration. This method
...
acquisition techniques due to its wide range coverage in a~relative short
period of time \citep{blakely1996,nabighian-etal2005}. The main applications
...
data, the result is a~scalar quantity denominated total-field anomaly. The
total-field anomaly represents the Euclidean norm of the magnetic induction
produced by the magnetic sources in the subsurface. By using the total-field
