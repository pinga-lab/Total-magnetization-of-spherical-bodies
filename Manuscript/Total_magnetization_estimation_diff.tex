...
%DIF DEL Total_magnetization_estimation.tex           Thu Mar 19 19:46:17 2015
%DIF ADD Total_magnetization_estimation_revised.tex   Fri Mar 20 02:03:44 2015
...
\DIFadd{Figure \ref{fig:intrusion-profile} shows a synthetic 
...
\DIFadd{and is embedded in nonmagnetic sediments (grey prisms). The sediments
...
\DIFadd{We applied our method to estimate the magnetization direction of the synthetic
...
on a plane with constant vertical coordinate equal to -800}\,\unit{m}\DIFaddFL{.
The data are in nT.}}
...
and its estimated location (black point), which was obtained
by applying the
Euler Deconvolution with a structural index equal to 3. Notice
