...
%DIF ADD Total_magnetization_estimation_revised.tex   Tue Mar 17 01:40:22 2015
...
\DIFadd{We applied our method to estimate the magnetization direction
of synthetic sources simulating two different complex scenarios. 
The first one simulates two significantly overlapping total-field 
anomalies produced by two uniformly magnetized sources. The first
source 
}\DIFaddend 
